...
interface ContactReceiveEmailProps {
...
export function ContactReceiveEmail({name, subject, message}: ContactReceiveEmailProps) {
    return (
        <Html>
            <Head/>
                ...
                <Body className="bg-white my-auto mx-auto font-sans">
                    <Container className="border border-solid border-red-600 rounder my-[40px] mx-auto p-4 w-[465px]">
                        ...
                        <Text className="text-center mt-4">
                            We have received a new contact form submission from {name}.
                        </Text>
                        <Hr className="my-4"/>
